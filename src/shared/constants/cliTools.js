...
export const MITM_TOOLS = {
  antigravity: {
    ...
    modelAliases: ["gemini-3.8-flash-high", "gemini-3.8-flash", "gemini-3.8-flash-medium", "gemini-3.8-flash-low", "gemini-3.7-flash-high", "gemini-3.7-flash", "gemini-3.7-flash-medium", "gemini-3.7-flash-low", "gemini-3.1-pro-low", "gemini-pro-agent", "claude-sonnet-4-6", "claude-opus-4-6-thinking", "gpt-oss-120b-medium", "gemini-3-flash"],
    defaultModels: [
