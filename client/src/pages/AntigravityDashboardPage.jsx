...
export default function AntigravityDashboardPage() {
  ...
  const statItems = stats ? [
    ...
    {
      icon: DollarSign, label: 'Chi phí (~USD)', value: `~$${((stats.totalTokens || 0) / 1000000 * 5.5).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
      color: '#10b981', bg: 'rgba(16,185,129,0.1)'
    },
  ] : [];
    ...
    <div>
      ...
      <div className="stat-grid" style={{ marginBottom: 20 }}>
        {[
          ...
          { label: 'Chi phí (~USD)', value: `~$${(used / 1000000 * 5.5).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, color: 'var(--green)' },
        ].map(s => (
