      ...
      {loading ? (
        ...
        <div className="card reveal">
          <div className="card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
            <span className="card-title"><BarChart3 size={15} style={{ color: '#e0a82e' }} /> Biểu đồ đường đi Tokens theo ngày</span>
            ...
            <svg viewBox="0 0 1000 160" width="100%" height="160" style={{ minWidth: 600, display: 'block' }}>
              <defs>
                <linearGradient id="gradIn" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#e0a82e" stopOpacity="0.25" />
                  <stop offset="100%" stopColor="#e0a82e" stopOpacity="0.00" />
                </linearGradient>
