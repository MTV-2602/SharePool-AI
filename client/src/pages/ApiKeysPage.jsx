...
export default function ApiKeysPage() {
  ...
  const handleReset = (id) => {
    setConfirmDialog({
      ...
      message: 'Bạn có chắc chắn muốn reset lượng quota đã dùng của key này về 0 không?',
      isDanger: true,
      onConfirm: async () => {
        try {
        ...
        <div className="modal-overlay" onClick={() => setConfirmDialog(null)}>
          <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 420 }}>
            <div className="modal-header">
              <span className="modal-title" style={{ color: confirmDialog.isDanger ? 'var(--red)' : 'var(--accent-light)' }}>
            ...
            <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end', marginTop: 20 }}>
              ...
              <button
                ...
                style={confirmDialog.isDanger ? { backgroundColor: 'var(--red)', borderColor: 'var(--red)' } : {}}
                onClick={() => {
